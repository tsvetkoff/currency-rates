...
public class RateRecord extends UpdatableRecordImpl<RateRecord> implements Record6<UUID, String, String, LocalDateTime, BigDecimal, BigDecimal> {
     ...
     */
    public RateRecord setDate(LocalDateTime value) {
        set(3, value);
        return this;
    }
    ...
    @Override
    public Row6<UUID, String, String, LocalDateTime, BigDecimal, BigDecimal> valuesRow() {
    ...
    @Override
    public RateRecord value4(LocalDateTime value) {
        setDate(value);
        return this;
    }
    ...
    @Override
    public RateRecord values(UUID value1, String value2, String value3, LocalDateTime value4, BigDecimal value5, BigDecimal value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RateRecord(UUID id, String bank, String currency, LocalDateTime date, BigDecimal purchase, BigDecimal sale) {
        super(Rate.RATE);
